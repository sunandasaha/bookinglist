        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-black-700 text-sm">
              For property owners, hotel, or homestay who want to manage
              bookings, rooms, and guest details through our platform.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-black-700 text-sm">
              For travel agents who book properties for clients and earn
              commissions on each successful booking.
            </p>
          </div>
        </div>
      </div>
