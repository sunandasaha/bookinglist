...
const CalendarGrid = forwardRef(
  ({ startDate, searchBID, searchTrigger }, ref) => {
    ...
    const toggleCell = (r, d) => {
      ...
      if (rooms[r]?.isDummy) {
        alert(
          "🚫 This room is not available. Please go to the 'Rooms & Pricing' section in the sidebar to make it available for booking."
        );
        return;
      }
      setTappedCells((prev) => {
        ...
        <div className="inline-block min-w-max border rounded-xl shadow-xl select-none">
          ...
          {rooms.map((room, rIdx) => (
            ...
            >
              ...
              >
                <div className=" flex  items-center text-blue-800  gap-1 font-bold text-l">
                  <Home size={13} /> {room.name}:{" "}
                ...
                <div className="text-xs text-gray-600 flex items-center gap-1 whitespace-nowrap overflow-hidden text-ellipsis">
                  ...
                  room.price?.four
                    ? room.capacity === 1
                      ...
                      : room.capacity === 2
                      ? `${room.price.two} /person`
                      : room.capacity === 3
                      ? `${room.price.three} / person`
          ...
          {selectedCells.length > 0 && !selectedBooking && (
            <div className="fixed bottom-6 right-6  z-50">
              <button
                ...
                className={clsx(
                  "Book w-15 h-15 rounded-full bg-blue-500 text-white flex items-center justify-center overflow-hidden",
                  hasBookedCellsInSelection
