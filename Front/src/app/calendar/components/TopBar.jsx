...
const handleSearchSubmit = (e) => {
  e.preventDefault();
  alert(`Searching Booking ID: ${searchQuery}`);
  setSearchOpen(false);
};
      ...
      {showSideMenu && (
        ...
        <div className="absolute left-0 top-16 w-64 bg-white shadow-xl rounded-r-lg border-t border-r border-b border-gray-200 z-50">
          <div className="p-4 space-y-2">
            <button className="flex items-center gap-3 w-full p-2 hover:bg-gray-100 rounded-lg text-left text-black">
  ...
  {searchOpen && (
    ...
    >
      ...
      <button
        type="submit"
        className="bg-green-500 text-black px-3 py-1 rounded text-sm hover:bg-green-600 text-black "
      >
        Search
      </button>
    </form>
